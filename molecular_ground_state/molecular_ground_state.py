...
if __name__ == "__main__":
    ...
    sweep_local = run_sweep(
        ...
        n_electrons=2,
        max_iterations=15,
        backend=QiskitSimulator(shots=5_000),
    )
    ...
    print(f"Phase 1 completed in {local_time:.1f}s")
    ...
    print(f"Local  (Phase 1): {local_time:.1f}s for {len(BOND_LENGTHS_LOCAL)} bond lengths")
